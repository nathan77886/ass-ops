...
- Add a canonical relation prune/repair pass for derived edges whose source domain rows were deleted or had nullable foreign keys cleared; current sync upserts current assets/relations and deduplicates snapshots but does not remove stale derived relations.
