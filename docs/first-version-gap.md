...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes to template-worker project creation, SSH machines, Argo connections, GitHub Actions pipelines, deployment records, template files, and manual relation edits.
