...
- Replace best-effort post-write refresh with transactionally maintained canonical assets/relations for projects, repositories, remotes, SSH machines, Argo connections, GitHub Actions pipelines, deployment records, template files, and manual relation edits.
