...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes, Argo/SSH create paths, manual relation creation, and template-worker project creation to Argo sync read models, GitHub Actions pipelines, deployment records, and remaining manual relation maintenance.
