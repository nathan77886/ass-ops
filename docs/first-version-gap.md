...
2. Add automated provider token rotation and protected-branch-aware credential strategy after rotation-due visibility and manual token-env rotation have covered the first operational guardrail.
