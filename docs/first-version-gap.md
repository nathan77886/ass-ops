...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes and Argo/SSH create paths to template-worker project creation, Argo sync read models, GitHub Actions pipelines, deployment records, template files, and manual relation edits.
