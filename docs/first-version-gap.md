...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes, Argo/SSH create paths, and manual relation creation to template-worker project creation, Argo sync read models, GitHub Actions pipelines, deployment records, template files, and remaining manual relation maintenance.
