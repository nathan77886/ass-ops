...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes, provider account management, webhook connection management, Argo/SSH create paths, manual relation maintenance, template-worker project creation, Argo app sync read models, and GitHub Actions pipeline read models to the remaining asset-producing CRUD paths.
