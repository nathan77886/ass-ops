...
- Extend transactionally maintained canonical assets/relations beyond RepoSyncAsset lifecycle writes to projects, repositories, remotes, SSH machines, Argo connections, GitHub Actions pipelines, deployment records, template files, and manual relation edits.
