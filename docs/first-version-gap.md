...
- Extend transactionally maintained canonical assets/relations beyond direct project/repository/remote/RepoSyncAsset lifecycle writes, Argo/SSH create paths, manual relation creation, template-worker project creation, and Argo app sync read models to GitHub Actions pipelines and remaining manual relation maintenance.
