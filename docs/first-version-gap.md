...
1. Turn the protected manual production-backup restore rehearsal into a scheduled environment job once backup storage access, credentials, and artifact retention are chosen.
