export const enPart02: Record<string, string> = {
    ...
    'field.kubeconfig_secret': 'Kubeconfig secret',
    ...
    'help.kubeconfig_secret_ref': 'Non-sensitive kubeconfig name/reference. Kubeconfig content is encrypted and stored in the database.',
    'help.kubeconfig_secret': 'Paste kubeconfig content here. API encrypts it, stores it in the database, and never returns it.',
    ...
    'help.rbac_restart_pods_status': 'Manual operator sign-off that the service account RBAC was reviewed for rollout restart access. The worker also checks access through the Kubernetes API before restarting.',
    ...
    'help.deployment_name': 'Kubernetes Deployment to restart through the Kubernetes API after approval and RBAC checks.',
    'help.container_name': 'Optional container name. Leave empty to use the Kubernetes default container.',
    'help.tail_lines': 'Maximum log lines the Kubernetes API may read for metadata counting and optional preview; capped at 200 by the gateway.',
