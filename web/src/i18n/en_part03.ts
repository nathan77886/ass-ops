export const enPart03: Record<string, string> = {
    ...
    'worker.registrationHint': 'Gateway includes the default local node. Install remote workers from SSH Machines; remote jobs use Cloudflare Queues.',
