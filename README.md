...
- Agent task list, read-only context plan generation from project operational context, agent-task asset graph entries, canonical asset graph snapshots, asset health snapshots, and tool-call audit visibility
